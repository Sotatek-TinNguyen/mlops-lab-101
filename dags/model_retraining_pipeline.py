...
data_collection = BashOperator(
    ...
    bash_command='python /app/src/data/collect_data.py',
    dag=dag
)
...
model_training = BashOperator(
    ...
    bash_command='python /app/src/training/train_model.py',
    dag=dag
)
...
model_evaluation = BashOperator(
    ...
    bash_command='python /app/src/evaluation/evaluate_model.py',
    dag=dag
)
